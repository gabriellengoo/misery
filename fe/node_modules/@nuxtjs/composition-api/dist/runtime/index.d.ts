 ...
 * @example
  ...
  ```
 */
declare const useAsync: <T>(cb: () => T | Promise<T>, key?: string | Ref<null>) => Ref<T | null>;
...
type SetupFunction = (this: void, props: Record<string, unknown>, ctx: SetupContext) => void | Record<any, any>;
/**
 ...
 */
declare const useMeta: <T extends MetaInfo, MetaRefs extends ToRefs<MetaInfoMapper<Required<MetaInfo>> & T>>(init?: T | (() => T) | undefined) => MetaRefs;
 ...
 * @deprecated
 */
declare const reqSsrRef: <T>(initialValue: T, key?: string) => Ref<T>;
 ...
 * @example
  ...
  ```
 */
declare const ssrRef: <T>(value: T | (() => T), key?: string) => Ref<T>;
/**
 ...
 * @example
  ...
  ```
 */
declare const shallowSsrRef: <T>(value: T | (() => T), key?: string) => Ref<T>;
/**
 ...
 * @example
    ...
    ```
 */
declare const ssrPromise: <T>(value: () => Promise<T>, key?: string) => Promise<T>;
 ...
 */
declare const wrapProperty: <K extends keyof vue.default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => vue.default<Record<string, any>, Record<string, any>, never, never, any>>, T extends boolean = true>(property: K, makeComputed?: T | undefined) => () => T extends true ? ComputedRef<vue.default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => vue.default<Record<string, any>, Record<string, any>, never, never, any>>[K]> : vue.default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => vue.default<Record<string, any>, Record<string, any>, never, never, any>>[K];
/**
...
declare const warn: () => void;
declare const createApp: () => void;
declare const createRef: () => void;
declare const defineAsyncComponent: () => void;
declare const isRaw: () => void;

export { createApp, createRef, defineAsyncComponent, defineComponent, defineNuxtMiddleware, defineNuxtPlugin, globalPlugin, isRaw, onGlobalSetup, reqRef, reqSsrRef, setMetaPlugin, setSSRContext, shallowSsrRef, ssrPromise, ssrRef, useAsync, useContext, useFetch, useMeta, useRoute, useRouter, useStatic, useStore, warn, withContext, wrapProperty };
